...
if(isset($_GET['login']) && $_GET['login']=='invalid'){ echo __('Wrong Username or Password.','bc-domain'); }
 ?></div>
	<div class="form-row form-row-username">
		...
		<input name="log" type="text" class="form-control login-field" value="" placeholder="Username" id="login-name" />
		
	</div>
	<?php do_action("login_form_after_username"); ?>
	<div class="form-row form-row-username">
		<label for="username"><?php echo  __('Password','bc-domain'); ?> :</label>
		<input  name="pwd" type="password" class="form-control login-field" value="" placeholder="Password" id="login-pass" />
   ...
   <?php do_action( 'login_form' ); ?>
	<div class="form-row form-row-remember">
		...
		<?php echo  __('Remember Me','bc-domain'); ?>
		</label>
	</div>
	<?php do_action("login_form_after_rememberme"); ?>
	<div class="form-row form-row-submit">
		<input class="bc-submit" type="submit"  name="bc_submit_login" value="Log in" />
		<a href="<?php echo bc_current_url('?action=lostpassword'); ?>" ><?php echo  __('Forgot Password','bc-domain'); ?></a>
	</div>
