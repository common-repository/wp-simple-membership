...
<?php if(isset($_GET['action']) && $_GET['action']=='lostpassword' &&
 ...
 ?></div>
	<div class="form-row form-row-email">
		<!--label for="email"><?php echo  __('Email Or Username','bc-domain'); ?> : <strong>*</strong></label-->
		<input type="text" class="user_login form-control" id="user_login" name="user_login" placeholder="<?php echo  __('Email Or Username','bc-domain'); ?>"></label>
	</div>
	...
	<!--label>&nbsp;</label-->
	<input type="submit" value="<?php echo  __('Reset Password','bc-domain'); ?>" class="reset_password" id="wp-submit" name="wp-submit">
	<a href="<?php echo  bc_current_url(); ?>" ><?php echo  __('Login','bc-domain'); ?></a>
	</div>
</form>
